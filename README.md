...
# Dataset
We utilized several APIs to retrieve data. However, we have also saved the retrieved datasets in the folder `data`. Retrieving data from the APIs requires confidential information (anyone can use the API, but has to create an account first) and takes a long time. 
